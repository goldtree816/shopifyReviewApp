...
export default function ProductGroupPage() {
  ...
  const filterOptions = [
    { label: 'Import reviews', value: 'import_reviews' },
    { label: 'Request reviews', value: 'request_reviews' },
    { label: 'Request scheduling', value: 'request_scheduling' },
    { label: 'Email templates', value: 'email_templates' },
    { label: 'Product management', value: 'product_management' },
    { label: 'Publishing and moderation', value: 'publishing_moderation' },
  ];
